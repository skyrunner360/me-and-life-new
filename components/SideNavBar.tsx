      ...
      <div>
        ...
        <List>
          {[
            {
              title: "Manage Brand",
              desc: "Manage Brandkit, Integrations & Uploads here",
              icon: <Work />,
              path: "/workspace",
              need_redirect: false,
            },
            {
              title: "My Account", //userName has "username"
              desc: "Check your account usage or upgrade plan", // username has "useremail"
              icon: <AccountCircle />,
              path: "/settings/",
              need_redirect: false,
            },
            ...
            <Tooltip title={!props?.open ? data?.title : ""} placement="right" arrow key={index}>
              <ListItem
                ...
                disablePadding
                sx={{ display: "block" }}
                onClick={() => props.handleDrawerClose && props.handleDrawerClose()}
              >
                {!data?.need_redirect ? (
                  <Link href={data?.path || ""} style={{ textDecoration: "none" }}>
                    <ListItemButton
        ...
        <List>
          {[
            {
              title: "Help",
              desc: "Let us help you use Predis better",
              icon: <QuestionMark />,
              path: "https://www.youtube.com/@predisai2234",
            },
          ].map((data, index) => (
            <ListItem
              key={index}
          ...
          {window.innerWidth < MOBILE_BREAKPOINT && (
            <Accordion
              ...
              sx={{ boxShadow: "none" }}
            >
              <AccordionSummary expandIcon={<ExpandMore />} className="more-option-accordion">
              ...
              <AccordionDetails sx={{ pt: 0 }}>
                {[
                  ...
                  {
                    title: "Refer, Invite & Earn",
                    icon: <MonetizationOn />,
                    path: "/settings/?tab=reward",
                  },
                  {
                    title: "Join our Community",
                    icon: <Groups />,
                    path: "https://www.facebook.com/groups/predisaiofficial/",
                  },
                  {
                    title: "Logout",
